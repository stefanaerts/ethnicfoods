...
export class CcpickerComponent implements OnInit, AfterViewInit {
  ...
  //          console.log('data status=' + data.statusText);
          ...
          'Please check internet connection and try again.If not working pls contact angular2firebaseconsultant@gmail.com');
